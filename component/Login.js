  ...
  return (
    <View style={ styles.container}>
      ...
      <View style={styles.loginWith}>
        <TouchableOpacity  style={styles.btn} onPress={GoHome}><Image source={WithGoogle} style={{width: 24, height: 25}}></Image></TouchableOpacity>
        <TouchableOpacity style={styles.btn} onPress={GoHome}><Image source={WithFacebook} style={{width: 27, height: 27}}></Image></TouchableOpacity>
      </View>
