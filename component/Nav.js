...
const styles = StyleSheet.create({
    container: {
        position: 'absolute',
        bottom: 0,
        width: '100%', // Lebar akan mengikuti lebar layar
        backgroundColor: 'transparent', // Atur latar belakang ke transparent agar tidak ada latar belakang yang ditampilkan
    },
    nav: {
        flexDirection: 'row',
