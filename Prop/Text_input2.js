...
export default function Text_Input({Placrholder, Placrholder1, Placrholder3}) {
  return (
    <View>
        ...
        <TextInput style={{width:345, height: 46,borderBottomWidth: 1, marginTop: 5, borderColor: '#DFDFDF',paddingLeft:23 }} placeholder={Placrholder} ></TextInput>
        <Image source={Lock} style={{width: 11 , height: 14, position: 'absolute', top: 78}}></Image>
        <TextInput style={{width:345, height: 46,borderBottomWidth: 1, marginTop: 12, borderColor: '#DFDFDF', paddingLeft: 23 }} placeholder={Placrholder1}></TextInput>
        <Image source={Lock} style={{width: 11 , height: 14, position: 'absolute', top: 138}}></Image>
        <TextInput style={{width:345, height: 46,borderBottomWidth: 1, marginTop: 12, borderColor: '#DFDFDF', paddingLeft: 23 }} placeholder={Placrholder3}></TextInput>
    </View>
